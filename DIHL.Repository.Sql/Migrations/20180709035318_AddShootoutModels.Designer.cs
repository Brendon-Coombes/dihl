...
namespace DIHL.Repository.Sql.Migrations
{
    ...
    [Migration("20180709035318_AddShootoutModels")]
    partial class AddShootoutModels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DIHL.Repository.Sql.Models.GameShootoutStatisticDataModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("GameShootoutStatistics");
                });
            ...
            modelBuilder.Entity("DIHL.Repository.Sql.Models.GoalieShootoutStatisticDataModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<Guid>("GameShootoutStatisticId");
                    ...
                    b.Property<bool>("WonShootout");

                    b.HasKey("Id");

                    b.HasIndex("GameShootoutStatisticId");

                    b.HasIndex("PlayerId");

                    b.HasIndex("TeamId");

                    b.ToTable("GoalieShootoutStatistics");
                });
            ...
            modelBuilder.Entity("DIHL.Repository.Sql.Models.SkaterShootoutStatisticDataModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("SkaterShootoutStatistics");
                });
            ...
            modelBuilder.Entity("DIHL.Repository.Sql.Models.GoalieShootoutStatisticDataModel", b =>
                {
                    b.HasOne("DIHL.Repository.Sql.Models.GameShootoutStatisticDataModel", "ShootoutStatistic")
                        .WithMany("GoalieShootoutStatistics")
                        .HasForeignKey("GameShootoutStatisticId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("DIHL.Repository.Sql.Models.SkaterShootoutStatisticDataModel", b =>
                {
                    b.HasOne("DIHL.Repository.Sql.Models.GameShootoutStatisticDataModel", "ShootoutStatistic")
                        .WithMany("SkaterShootoutStatistics")
                        .HasForeignKey("GameShootoutStatisticId")
                        .OnDelete(DeleteBehavior.Restrict);
